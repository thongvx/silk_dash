            ...
            <div
                ...
                <div
                    ...
                    <button
                        ...
                        profile hover:text-[#009FB2]  text-white tab-lifted [--tab-border-color:#121520] tab font-bold h-auto text-md px-4 [--tab-bg:#121520] !border-b-0 lg:!border-b-1 !rounded-b-lg lg:!rounded-b-none before:!hidden lg:before:!block"
                    ...
                    <button
                        ...
                        ticket hover:text-[#009FB2]  text-white tab-lifted [--tab-border-color:#121520] tab font-bold h-auto text-md px-4 [--tab-bg:#121520] !border-b-0 lg:!border-b-1 !rounded-b-lg lg:!rounded-b-none before:!hidden lg:before:!block"
                    ...
                    <button
                        ...
                        playersetting hover:text-[#009FB2]  text-white tab-lifted [--tab-border-color:#121520] tab font-bold h-auto text-md px-4 [--tab-bg:#121520] !border-b-0 lg:!border-b-1 !rounded-b-lg lg:!rounded-b-none before:!hidden lg:before:!block"
                    ...
                    <button
                        ...
                        customads hover:text-[#009FB2]  text-white tab-lifted [--tab-border-color:#121520] tab font-bold h-auto text-md px-4 [--tab-bg:#121520] !border-b-0 lg:!border-b-1 !rounded-b-lg lg:!rounded-b-none before:!hidden lg:before:!block"
                    ...
                    <button
                        ...
                        activities hover:text-[#009FB2]  text-white tab-lifted [--tab-border-color:#121520] tab font-bold h-auto text-md px-4 [--tab-bg:#121520] !border-b-0 lg:!border-b-1 !rounded-b-lg lg:!rounded-b-none before:!hidden lg:before:!block"
