...
<body
    class="!font-[Roboto] m-0 font-sans text-base bg-[#121520] antialiased font-normal leading-default text-slate-500 min-h-screen h-full">
<!-- sidenav  -->
<aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full xl:w-max p-0 my-4
         ...
         ease-nav-brand z-30 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" style="background-color: #142132" aside-menu
       aria-expanded="false">
    <div class="h-19">
...
<!-- end sidenav -->
<div id="loading">
    <div class="loader bg-[#121520]"></div>
</div>
<main class="relative h-full transition-all duration-200 ease-in-out xl:ml-24 rounded-xl bg-[#121520]">
    <!-- Navbar -->
    <nav
        class="sticky top-0 flex z-20 flex-wrap bg-[#121520] items-center justify-between px-3 py-2 lg:px-3 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start"
            ...
            <div class="flex items-center justify-between mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                <div class="flex items-center md:ml-auto pr-4">
                    <div class="flex items-center relative bg-[#142132] w-full rounded-lg ease" search>
                        <label class="p-1 flex bg-[#142132] items-center translate-x-3 transition duration-300 ease-in-out z-10 absolute text-slate-400">Search video...</label>
                        </span>
                        <input type="text"
                ...
                <ul class="items-center	flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                    ...
                    <li class="relative flex items-center pr-2">
                        ...
                        <ul dropdown-menu
                            class="text-sm transform-dropdown bg-[#142132] before:font-awesome before:leading-default before:duration-350 before:ease
                       ...
                       before:inline-block before:font-normal before:text-[#142132] before:antialiased before:transition-all before:text-xl before:content-['▲'] sm:-mr-6
    ...
    <!-- end Navbar -->
    <!-- cards -->
    <div class="w-full px-3 md:px-6 mx-auto bg-[#121520]">
        <div class="min-h-[calc(100vh-10em)]">
            <div class="flex flex-col" box-lifted data-page="upload">
                <div
                    ...
                    <button
                        class="tab-upload webupload tab-lifted [--tab-border-color:#142132] tab text-white font-bold h-auto text-md px-4 [--tab-bg:#142132] !border-b-0 md:!border-b-1 !rounded-b-lg md:!rounded-b-none before:!hidden md:before:!block"
                        data-content="webupload">
                        <i class="material-icons mr-3 py-2">cloud_upload</i>File Upload
                    </button>
                    <button
                        class="tab-upload transfer tab-lifted [--tab-border-color:#142132] tab text-white font-bold h-auto text-md px-4 [--tab-bg:#142132] !border-b-0 md:!border-b-1 !rounded-b-lg md:!rounded-b-none before:!hidden md:before:!block"
                        data-content="transfer">
                        <i class="material-icons mr-3 py-2">link</i>Remote / URL Upload
                    </button>
                    <button
                        class="tab-upload clone tab-lifted [--tab-border-color:#142132] tab text-white font-bold h-auto text-md px-4 [--tab-bg:#142132] !border-b-0 md:!border-b-1 !rounded-b-lg md:!rounded-b-none before:!hidden md:before:!block"
                        data-content="clone">
                ...
                <div class="mt-3 md:mt-0 rounded-b-box rounded-se-box relative">
                    <div
                        class="border-[#142132] rounded-b-box rounded-se-box gap-2 bg-[#142132] bg-top p-4 [border-width:var(--tab-border)]"
                    >
                        <div id="webupload" class="">
                            <div class="text-center pb-10">
                                ...
                                <form class='lg:mx-32 from-current' method="POST" id="form-upload-file" action="https://e01.streamsilk.com/upload"
                                    ...
                                    @csrf
                                    <label htmlfor="file" class="rounded-xl py-10 bg-[#121520] flex justify-center flex-col h-full w-full relative ">
