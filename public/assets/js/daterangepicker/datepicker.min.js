!function (e, t) {
    ...
    return function () {
        ...
        var e = {
            482: function (e, t, i) {
                ...
                function d(e, t) {
                    ...
                    const r = e.datepickers, a = {render: !1}, n = e.inputs.indexOf(i), s = 0 === n ? 1 : 0,
                        o = r[n].dates[0], d = r[s].dates[0];
                ...
                class c {
                    constructor(e, t = {}) {
                        ...
                        const r = d.bind(null, this), a = s(t), n = [];
                        Object.defineProperty(this, "datepickers", {
                            get() {
                                return n
                            }
                        }), o(this, r, this.inputs[0], a), o(this, r, this.inputs[1], a), Object.freeze(n), n[0].dates.length > 0 ? d(this, {target: this.inputs[0]}) : n[1].dates.length > 0 && d(this, {target: this.inputs[1]})
                    }
                ...
                var r = i(105), a = i(560), n = i(963), s = i(698);
                const o = {
                    en: {
                ...
                class O extends S {
                    ...
                    updateFocus() {
                        const e = new Date(this.picker.viewDate), t = e.getFullYear(), i = e.getMonth(),
                            r = (0, a.by)(t, i, 1), n = (0, a.fr)(r, this.weekStart, this.weekStart);
                    ...
                    refresh() {
                        ...
                        this.grid.querySelectorAll(".range, .range-start, .range-end, .selected, .focused").forEach((e => {
                            ...
                            const r = Number(i.dataset.date), a = i.classList;
                ...
                class E extends S {
                    ...
                    updateSelection() {
                        ...
                        this.selected = e.reduce(((e, t) => {
                            const i = new Date(t), a = i.getFullYear(), n = i.getMonth();
                    ...
                    render() {
                        ...
                        const e = this.selected[this.year] || [],
                            ...
                            r = this.year === this.maxYear, n = C(this.range, this.year);
                        Array.from(this.grid.children).forEach(((s, o) => {
                            const d = s.classList, c = (0, a.by)(this.year, o, 1);
                ...
                class F extends S {
                    ...
                    updateFocus() {
                        const e = new Date(this.picker.viewDate), t = (0, a.ak)(e, this.navStep), i = t + 9 * this.step;
                    ...
                    render() {
                        this.disabled = [], this.picker.setViewSwitchLabel(`${this.first}-${this.last}`), this.picker.setPrevBtnDisabled(this.first <= this.minYear), this.picker.setNextBtnDisabled(this.last >= this.maxYear), Array.from(this.grid.children).forEach(((e, t) => {
                            const i = e.classList, r = this.start + t * this.step, n = (0, a.by)(r, 0, 1);
                    ...
                    refresh() {
                        ...
                        this.grid.querySelectorAll(".range, .range-start, .range-end, .selected, .focused").forEach((e => {
                            ...
                            const r = Number(i.textContent), a = i.classList;
                ...
                function I(e) {
                    const {dates: t, config: i} = e, a = t.length > 0 ? (0, r.Jm)(t) : i.defaultViewDate;
                ...
                class z {
                    constructor(e) {
                        ...
                        const t = x.replace(/%buttonClass%/g, e.config.buttonClass),
                            i = this.element = l(t).firstChild, [r, a, n] = i.firstChild.children,
                        ...
                        i.classList.add(`datepicker-${p}`), "dropdown" === p && i.classList.add("dropdown", "absolute", "top-0", "left-0", "z-50", "pt-2"), K(this, e.config), this.viewDate = I(e), (0, s.cF)(e, [[i, "click", H.bind(null, e), {capture: !0}], [a, "click", T.bind(null, e)], [f.viewSwitch, "click", $.bind(null, e)], [f.prevBtn, "click", j.bind(null, e)], [f.nextBtn, "click", _.bind(null, e)], [f.todayBtn, "click", W.bind(null, e)], [f.clearBtn, "click", Y.bind(null, e)]]), this.views = [new O(this), new E(this), new F(this, {
                            id: 2,
                            name: "years",
                            cellClass: "year",
                            step: 1
                    ...
                    place() {
                        const {classList: e, style: t} = this.element, {config: i, inputField: r} = this.datepicker,
                            a = i.container, {width: n, height: s} = this.element.getBoundingClientRect(), {
                                left: o,
                                top: d,
                                width: c
                ...
                function J(e, t, i, r) {
                    const n = e.picker, s = n.currentView, o = s.step || 1;
                ...
                function G(e, t) {
                    ...
                    const i = e.picker, {id: r, isMinView: a} = i.currentView;
                    if (i.active) if (e.editMode) switch (t.key) {
                        ...
                        case"Escape":
                            ...
                            break;
                        case"ArrowLeft":
                            if (t.ctrlKey || t.metaKey) B(e, -1); else {
                        ...
                        case"ArrowRight":
                            ...
                            break;
                        case"ArrowUp":
                            if (t.ctrlKey || t.metaKey) V(e); else {
                                if (t.shiftKey) return void e.enterEditMode();
                                J(e, t, -1, !0)
                            }
                            break;
                ...
                class ne {
                    constructor(e, t = {}, i) {
                        ...
                        let c, l;
                        if (o) n.container = e, l = (0, r.W7)(e.dataset.date, n.dateDelimiter), delete e.dataset.date; else {
                ...
                var r = i(560), a = i(105);
                const n = /dd?|DD?|mm?|MM?|yy?(?:yy)?/, s = /[\s!-/:-@[-`{-~年月日]+/;
                let o = {};
                const d = {
                    y(e, t) {
                ...
                function u(e) {
                    ...
                    const t = e.split(n), i = e.match(new RegExp(n, "g"));
                ...
                function c(e, t) {
                    const i = new Date(e), r = i.getMonth(), a = i.setFullYear(i.getFullYear() + t);
                ...
                const r = new WeakMap, {addEventListener: a, removeEventListener: n} = EventTarget.prototype;
        ...
        return function () {
            ...
            var e = i(770), t = i(482), a = i(947), n = function (e) {
                var t = e.hasAttribute("datepicker-buttons"), i = e.hasAttribute("datepicker-autoselect-today"),
                    r = e.hasAttribute("datepicker-autohide"), a = e.hasAttribute("datepicker-format"),
                    n = e.hasAttribute("datepicker-orientation"), s = e.hasAttribute("datepicker-title"), o = {};
            ...
            function s() {
                document.querySelectorAll("[datepicker]").forEach((function (t) {
                    ...
                    new t.Z(e, {...n(e), maxDate: new Date(), orientation: "bottom"})
                }))
            }
