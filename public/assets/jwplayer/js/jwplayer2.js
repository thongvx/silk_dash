        ...
        var e, t, n = {
            ...
            623: (e,t,n)=>{
                ...
                const S = function(e) {
                    ...
                    , D = (e,t)=>{
                    const n = [B(e)];
                    return x(e) || n.push(Promise.resolve()),
                        Promise.all(n)
                }
                    , _ = (e,t)=>function(e, t) {
                ...
                Object.assign(te.prototype, {
                    ...
                    init(e, t) {
                        ...
                        return n.on("change:errorEvent", Y),
                            this.setup.start(t).then((e=>{
                                    ...
                                    const a = this._model;
                                    return n.off("change:errorEvent", Y),
                                        a.on("change:errorEvent", Y),
                                        r.track(a),
            ...
            4446: (e,t,n)=>{
                ...
                const x = function(e, t, n) {
                    ...
                    , T = function(e, t) {
                    const n = x(A, t, e);
                    return n.code = (e && e instanceof S && e.code || 0) + t,
                        n
                }
                    , B = function(e) {
            ...
            974: (e,t,n)=>{
                ...
                const a = o().clear
                    ...
                    if (/^\w+\(/i.test(e))
                        return i = /^(\w+)\(/i.exec(e)[1],
                            o = /^\w+\(([^),]+),\s*([^,)]+),\s*([^,)]+),?\s*([^),]*)\)/i.exec(e).slice(1),
                        3 === i.length && (i += "a"),
                            n && o[3].length ? o[3] *= s : o[3] = s,
                            g(i, o);
                    e = null != (r = (e=>{
                            let t = 0
                                , n = h;
                    ...
                    for (let t = 0; t < m.length; t++) {
                        const r = m[t];
                        if (r.test.test(e))
                            return o = r.extract.exec(e).slice(1).map(r.map),
                                n && r.alpha ? o[3] = o[3] / 255 * s : o[3] = s,
                                g(i, o)
                    }
                    return g(i, o)
                }
            ...
            2799: (e,t,n)=>{
                ...
                const s = (e,t)=>e.classList.contains(t)
                    ...
                    for (let n = t.length; n--; ) {
                        const r = t[n].name
                            , i = t[n].value;
                        /^\s*(javascript(:|&colon;))/.test(i) && (e.removeAttribute(r),
                            console.warn("Invalid or unsafe javascript removed")),
            ...
            8518: (e,t,n)=>{
                ...
                const P = (e,t,n,r)=>{
                    ...
                    return P(n, "errors", e, t),
                        P(n, "related", e, t),
                        P(n, "sharing", e, t),
                        P(n, "advertising", e, t),
                        P(n, "shortcuts", e, t),
                        P(n, "captionsStyles", e, t),
                        n
                }
            }
            ,
            ...
            5882: (e,t,n)=>{
                ...
                const b = (e,t,n)=>{
                    ...
                    , E = (e,t)=>{
                    if (v || (v = new _(document).on("interaction")),
                    ...
                    E(e, h),
                        O(e, h, (n=>{
                                const {target: r} = n;
                                P(n) || Boolean(e.directSelect) && r !== t || (n.isPrimary && "BUTTON" === r.tagName && r.focus(),
                                    e.lastStart = (0,
                                        s.z)(),
                                    e.clicking = !0)
                            }
                        ...
                        C(e, h, "click", (n=>{
                                P(n) || Boolean(e.directSelect) && n.target !== t || ((0,
                ...
                class _ extends o.ZP {
                    ...
                    on(e, t, n) {
                        return D(e) && (this.handlers[e] || T[e](this)),
                            super.on(e, t, n)
                    }
                    off(e, t, n) {
                        if (D(e))
            ...
            6042: (e,t,n)=>{
                ...
                const te = function(e) {
                    ...
                    matches: he,
                    max: function(e, t, n) {
                        if (!t && Z(e) && e[0] === Number(e[0]) && e.length < 65535)
                            return Math.max(...e);
                        let r = -1 / 0
                            , i = -1 / 0;
            ...
            6577: (e,t,n)=>{
                ...
                Object.assign(x.prototype, {
                    ...
                    trigger(e, t) {
                        return (t = E.ZP.isObject(t) ? Object.assign({}, t) : {}).type = e,
                ...
                const T = e=>{
                    ...
                    , B = function(e) {
                        let t, n;
                        if (e ? "string" == typeof e ? (t = T(e),
                        t || (n = document.getElementById(e))) : "number" == typeof e ? t = s.Z[e] : e.nodeType && (n = e,
                            t = T(n.id || n.getAttribute("data-jwplayer-id"))) : t = s.Z[0],
                            t)
                            return t;
                        if (n) {
                            const e = new x(n);
                ...
                Object.assign(ee, z),
                    D(ee),
                "function" == typeof J.define && J.define.amd && J.define([], (function() {
                        return ee
                    }
                ));
                let te = ee;
...
var jwDefaults = {
    ...
    "displaytitle": true,
    "height": 360,
    "key": "FqeFeVB8Ap+MTZ78EQcoUgzvqeepQnKLtQ5C8BtE2FHTL2yE1ceXsymYG3B/hVHK",
    "mute": false,
    "ph": 1,
    "pid": "KB5zFt7A",
